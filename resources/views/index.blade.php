...
<html lang="en-US">
    <head>
        <title>Welcome | Barad Innovations</title>
    ...
    <body>
        ...
        <div id="home" class="section intro-page">
            <div class="block content-1170 center-relative center-text">
                <img class="top-logo" src="{{asset('demo-images/logo.png')}}" alt="Boxus" />
                <br>
                <h1 class="big-title">We Create Lasting <span>Memories</span></h1>
                <p class="title-desc">Let us handle your events!</p>
            </div>
        </div>
                            ...
                            <ul id="slider1" class="image-slider slides">
                                <li>
                                    <div class="service-holder ">
                                        <img src="{{asset('demo-images/icon_01.png')}}" alt="">
                                        <div class="service-content-holder">
                                            <div class="service-title">LOGISTICS</div>
                                    ...
                                    <div class="service-holder ">
                                        <img src="{{asset('demo-images/icon_02.png')}}" alt="">
                                        <div class="service-content-holder">
                                            <div class="service-title">VENUE</div>
                                            <div class="service-content">
                                    ...
                                    <div class="service-holder ">
                                        <img src="{{asset('demo-images/icon_03.png')}}" alt="">
                                        <div class="service-content-holder">
                                    ...
                                    <div class="service-holder ">
                                        <img src="{{asset('demo-images/icon_04.png')}}" alt="">
                                        <div class="service-content-holder">
                                            <div class="service-title">MEDIA</div>
                                            <div class="service-content">
            ...
            <div class="block content-1170 center-relative">
                ...
                <div class="section-content-holder portfolio-holder left">
                    <div class="grid" id="portfolio-grid">
                            ...
                            <a href="single-portfolio.html">
                                ...
                                <div class="portfolio-text-holder">
                                    <div class="portfolio-text-wrapper">
                                        ...
                                        <p class="portfolio-text">Wedding 1</p>
                                        <p class="portfolio-sec-text">Tayo & Tolu 2015</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                            ...
                            <a href="single-portfolio2.html">
                                ...
                                <div class="portfolio-text-holder">
                                    <div class="portfolio-text-wrapper">
                                        ...
                                        <p class="portfolio-text">Welcome Party 1</p>
                                        <p class="portfolio-sec-text">The Ajisafes welcome their son from the UK</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                            ...
                            <a data-rel="prettyPhoto[gallery1]" href="demo-images/portfolio_item_08.jpg">
                                ...
                                <div class="portfolio-text-holder">
                                    <div class="portfolio-text-wrapper">
                                        ...
                                        <p class="portfolio-text">Birthday 1</p>
                                        <p class="portfolio-sec-text">Ola Posh 29th Birthday Bash</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                        <div class="grid-item element-item p_one">
                            <a data-rel="prettyPhoto[gallery1]" href="demo-images/portfolio_item_05.jpg">
                                <img src="{{asset('demo-images/portfolio_item_05.jpg')}}" alt="">
                                <div class="portfolio-text-holder">
                                    <div class="portfolio-text-wrapper">
                                        <p class="portfolio-type">
                                            <img src="images/icon_post.svg" alt="">
                                        </p>
                                        <p class="portfolio-text">Wedding 2</p>
                                        <p class="portfolio-sec-text">Chima & Stephanie 2018</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="block portfolio-load-more-holder">
                        ...
                        <img src="{{asset('images/icon_infinity.svg')}}" alt="Load more">
                    </div>
                </div>
                <div class="clear"></div>
            </div>
            ...
            <div class="block content-1170 center-relative">
                ...
                <div class="section-content-holder right">
                    <div class="content-wrapper">
                        ...
                        <div class="one_half ">
                          <strong>Barad</strong> is the leading event management company in Nigeria. Established in 2017, our goal has been to create bespoke exceptional events for our varied clientele.<br>We believe every event has got a brand/reputation to protect and promote, that is why we pay the utmost attention to detail in all our undertakings.
                        </div>
                        <div class="one_half last ">
                         <img src="{{asset('images/brd-1.jpg')}}" alt="">  
                        ...
                        <div class="image-slider-wrapper relative img aboutImage">
                            ...
                            <div class="caroufredsel_wrapper">
                                <ul id="aboutImage" class="image-slider slides">
                                    <li><img src="{{asset('demo-images/about_img_04.jpg')}}" alt=""></li>
                                    <li><img src="{{asset('demo-images/about_img_05.jpg')}}" alt=""></li>
                                    <li><img src="{{asset('demo-images/about_img_06.jpg')}}" alt=""></li>
                                </ul>
                            </div>
                            <div class="clear"></div>
                        </div>
                                ...
                                <ul id="team1" class="image-slider slides">
                                    <li>
                                        <div class="member-content-holder">
                                            <h4 class="member-name">Bewaji Ayorinde</h4>
                                            <p class="member-position">CHAIRMAN</p>
                                            <div class="member-content">
                                               Entrepreneur extraordinaire, with a passion to deliver the best lasting memories for his clients, that is why we pay the utmost attention to detail in all projects.<br>
                                            </div>
                                        </div>
                                        <div class="member-image-holder">
                                            <img src="{{asset('demo-images/about_img_01.jpg')}}" alt="">
                                        </div>
                                        <div class="clear"></div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="member-image-holder">
                                            <img src="{{asset('demo-images/about_img_02.jpg')}}" alt="">
                                        </div>
                                        <div class="clear"></div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="member-image-holder">
                                            <img src="{{asset('demo-images/about_img_03.jpg')}}" alt="">
                                        </div>
                                        <div class="clear"></div>
                                    </li>
                                </ul>
                            ...
                            <ul id="text1" class="slides testimonial">
                                <li>
                                    <div class="testimonial-content">
                                        <p class="testimonial-text">My passion to deliver the best lasting memories for my clients.</p>
                                        <p class="testimonial-author">BEWAJI AYORINDE</p>
                                    </div>
                                    <div class="clear">
                                    </div>
                                </li>
                ...
                <div class="section-content-holder right">
                    ...
                    <div class="full-width ">
                        <a class="video-popup-holder" href="https://vimeo.com/157276599" data-rel="prettyPhoto[gallery-video1]">
                            ...
                            <img class="popup-play" src="{{asset('images/icon_video.svg')}}" alt="Play">
                        </a>
                    </div>
                </div>
                <div class="clear"></div>
                ...
                <div class="fwslider1 fw-image-slider-holder list_carousel relative">
                    <div class="caroufredsel_wrapper">
                        <ul id="fwslider1" class="fw-image-slider">
                            <li class="fw-slide">
                                <img src="{{asset('demo-images/icon_editing.png')}}" alt="">
                                <p class="fw-slide-text">Video Editing</p>
                            </li>
                            <li class="fw-slide">
                                <img src="{{asset('demo-images/icon_clear.png')}}" alt="">
                                <p class="fw-slide-text">Premium Cleer</p>
                            </li>
                            <li class="fw-slide">
                                <img src="{{asset('demo-images/icon_display.png')}}" alt="">
                                <p class="fw-slide-text">For All Displays</p>
                            </li>
                            <li class="fw-slide">
                                <img src="{{asset('demo-images/icon_time.png')}}" alt="">
                                <p class="fw-slide-text">Right On Time</p>
                            </li>
                            <li class="fw-slide">
                                <img src="{{asset('demo-images/icon_ideas.png')}}" alt="">
                                <p class="fw-slide-text">Innovative Ideas</p>
                            </li>
                            <li class="fw-slide">
                                <img src="{{asset('demo-images/icon_sound.png')}}" alt="">
                                <p class="fw-slide-text">Perfect Sound</p>
                            </li>
                            <li class="fw-slide">
                                <img src="{{asset('demo-images/icon_solution.png')}}" alt="">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="progress_bar ">
                            <div class="progress_bar_field_holder" style="width:81%;">
                                <div class="progress_bar_title" style="color: #55B286">LOGISTICS</div>
                        ...
                        <div class="progress_bar ">
                            <div class="progress_bar_field_holder" style="width:93%;">
                                <div class="progress_bar_title" style="color: #E3A536">VENUE</div>
                        ...
                        <div class="progress_bar ">
                            <div class="progress_bar_field_holder" style="width:72%;">
                                <div class="progress_bar_title" style="color: #B24564">MEDIA</div>
                        ...
                        <div class="progress_bar ">
                            <div class="progress_bar_field_holder" style="width:99%;">
                                <div class="progress_bar_title" style="color: #468ac7">DECOR</div>
            ...
            <div class="footer content-1170 center-relative">
                <ul>
                    <li class="copyright-footer">
                        © 2018 All rights reserved. | <a href="#" target="_blank">Barad Innovations</a>
                    </li>
        ...
        <script type='text/javascript' src='{{asset("js/jquery.dryMenu.js")}}'></script>
